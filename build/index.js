...
function Edit() {
  ...
  const paragraphBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => select('core/block-editor').getBlocks().filter(block => block.name === 'core/paragraph'), []);
  ...
  const totalCount = paragraphBlocks.reduce((acc, block) => {
    ...
    const blockContent = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getBlocksByClientId(block.clientId)[0].attributes.content;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkreading_time_block"] = globalThis["webpackChunkreading_time_block"] || [];
